      ...
      <main className="text-[#f0e7d7]">
        ...
        <section className="relative px-6 pt-16 pb-20 overflow-hidden">
          ...
          <div className="relative max-w-xl mx-auto text-center">
            <Reveal>
              <p className="text-xs tracking-[0.25em] text-[#8f7e69] uppercase mb-6">
                24시간 4,500원 몰입 공간
              </p>
              ...
              <p className="text-xs text-[#8f7e69] mt-6 tracking-wide">
        ...
        <section className="px-6 py-20 max-w-xl mx-auto text-center">
          <Reveal>
            <p className="text-[15px] leading-[2.1] text-[#d0c3ad]">
              해야 할 일을 펼쳐 놓고도<br />
              5분마다 폰을 집어 들고,
            </p>
          </Reveal>
          <Reveal delay={100}>
            <p className="text-[15px] leading-[2.1] text-[#d0c3ad] mt-8">
              카페에 가면 소음과 시선에,<br />
              집에 있으면 침대의 유혹에 무너지고.
            </p>
          </Reveal>
          <Reveal delay={200}>
            <p className="text-[15px] leading-[2.1] text-[#f0e7d7] font-medium mt-8">
              의지가 약해서가 아닙니다.<br />
        ...
        <section className="px-6 py-20 bg-[#332619] border-y border-white/10">
          <div className="max-w-xl mx-auto text-center">
            <Reveal>
              ...
              <p className="text-[15px] leading-[1.9] text-[#aa9a83]">
                흩어진 생각을 하나로 모으는 일에는<br />
                방해받지 않는 시간과 공간이 필요합니다.<br />
                잠시 머물며, 오롯이 몰입해 보세요.
              </p>
              <p className="text-[15px] leading-[1.9] text-[#aa9a83] mt-6">
                일기, 독서, 생각 정리, 아이디어 —<br />
                무엇이든 좋습니다.{' '}
                <span className="text-[#f0e7d7] font-medium">한 호흡에 하나만.</span>
              </p>
            </Reveal>
          </div>
        </section>
        ...
        <section className="px-6 py-16">
          <div className="max-w-xl mx-auto">
            <Reveal>
              <p className="text-xs tracking-[0.2em] text-[#8f7e69] uppercase text-center mb-12">
                이용 방법
              </p>
            </Reveal>
            <div className="grid grid-cols-3 gap-4 text-center">
              {[
                ...
                <Reveal key={s.n} delay={i * 120}>
                  <div className="text-sm text-[#6b5e4e] mb-3 font-medium">{s.n}</div>
                  <div className="text-[15px] font-medium mb-2">{s.t}</div>
                  <div className="text-xs text-[#8f7e69] leading-relaxed whitespace-pre-line">
                    {s.d}
                  </div>
                </Reveal>
              ))}
              ...
              <Reveal key={f.t} delay={i * 120}>
                <div className="flex gap-5 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#aa9a83] leading-relaxed">{f.d}</p>
                  </div>
                </div>
              </Reveal>
            ))}
        ...
        {/* ───────── 요금: 하루 vs 멤버십 ───────── */}
        <section className="px-6 py-20 mt-8 bg-[#332619] border-y border-white/10">
          <div className="max-w-xl mx-auto">
            <Reveal>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {/* 하루 이용권 */}
              <Reveal>
                <div className="h-full rounded-3xl border border-white/15 bg-[#2b2018] p-7 flex flex-col">
                  <p className="text-xs tracking-[0.15em] text-[#8f7e69] uppercase mb-3">
                    가볍게
                  </p>
                  ...
                  <ul className="space-y-2 text-sm text-[#aa9a83] mb-6 flex-1">
                    <li>입실부터 24시간</li>
                    <li>자유로운 외출과 출입</li>
                    <li>예약 없이 방문도 가능</li>
                  </ul>
                  <a
                    href="#booking"
                    className="block py-3.5 rounded-xl border border-[#e9c46a]/25 text-center text-sm font-medium text-[#f0e7d7] hover:border-[#e9c46a]/55 transition"
                  >
                    하루 예약하기
                  </a>
                </div>
              ...
              {/* 멤버십 */}
              <Reveal delay={120}>
                <div className="relative h-full rounded-3xl bg-[#160f08] text-white p-7 flex flex-col shadow-[0_16px_48px_rgba(18,18,42,0.25)]">
                  <span className="absolute -top-3 left-6 rounded-full bg-[#e9c46a] text-[#f0e7d7] text-[11px] font-bold px-3 py-1">
                    매일 오는 분께
                  </span>
                  ...
                  <a
                    href="#membership"
                    className="block py-3.5 rounded-xl bg-[#332619] text-center text-sm font-semibold text-[#f0e7d7] hover:bg-white/10 transition"
                  >
                    멤버십 시작하기
                  </a>
                </div>
            ...
            <Reveal>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[15px] font-medium text-[#f0e7d7]">
                      소중한 사람에게 몰입을 선물하세요
                    </p>
                    <p className="text-xs text-[#aa9a83] mt-0.5">
        ...
        {/* ───────── 공간 & 위치 ───────── */}
        <section className="py-20 mt-8 bg-[#332619] border-y border-white/10 overflow-hidden">
          <div className="max-w-md mx-auto text-center px-6">
            <Reveal>
              <p className="text-xs tracking-[0.2em] text-[#8f7e69] uppercase mb-2">
                Space
              </p>
            </Reveal>
          </div>
          ...
          <div className="max-w-md mx-auto text-center px-6 mt-8">
            <Reveal>
              <p className="text-[15px] leading-[1.9] text-[#d0c3ad] mb-6">
                값비싼 몰입의 시간을 사는,<br />
                〈몰입, 흐름 그리고 나〉는<br />
                <span className="text-[#f0e7d7] font-medium">쌍문역 3번 출구</span>에서 도보 8분,<br />
                조용한 골목에 있습니다.
              </p>
              <p className="text-sm leading-relaxed text-[#aa9a83] mb-10">
                혼자, 혹은 친구와 단둘이 오셔서<br />
                평온한 럭셔리를 누리시길 바라요.
              </p>

              <div className="rounded-2xl border border-white/10 bg-[#2b2018] p-6 text-left mb-8">
                <ul className="space-y-3.5 text-sm text-[#d0c3ad]">
                  <li className="flex gap-3">
                    <span className="shrink-0">🕐</span>
                    <span>
                      <strong className="text-[#f0e7d7] font-medium">24시간 영업</strong> · 연중무휴
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="shrink-0">☕</span>
                    <span>
                      ...
                      <span className="text-[#aa9a83]">물은 준비되어 있습니다.</span>
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="shrink-0">📶</span>
                    <span>와이파이 <strong className="text-[#f0e7d7] font-medium">있습니다</strong></span>
                  </li>
                  <li className="flex gap-3">
                    <span className="shrink-0">🚪</span>
              ...
              <div className="grid grid-cols-2 gap-3">
                <a
                  ...
                  className="py-3.5 rounded-xl border border-white/15 bg-[#332619] text-sm font-medium text-[#f0e7d7] hover:border-white/30 transition"
                >
                  📞 전화하기
                </a>
                <a
              ...
              <div className="mt-6 rounded-2xl border border-[#03c75a]/30 bg-[#03c75a]/[0.04] p-5 text-center">
                <p className="text-sm text-[#d0c3ad] mb-1">
                  다녀가셨다면, <strong className="text-[#f0e7d7]">첫 이야기</strong>를 남겨주세요
                </p>
                <p className="text-xs text-[#8f7e69] mb-4">
            ...
            <Reveal>
              <div className="grid grid-cols-2 gap-3 mb-8">
                {[
                  ...
                  <div
                    key={u.t}
                    className="rounded-2xl border border-white/10 bg-[#332619] p-5 text-center"
                  >
                    <div className="text-2xl mb-2">{u.e}</div>
                    <p className="text-sm font-medium text-[#f0e7d7]">{u.t}</p>
                  </div>
                ))}
              </div>
              <div className="rounded-2xl border border-white/10 bg-[#332619] p-6 text-center">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="py-3.5 rounded-xl bg-[#e9c46a] text-sm font-medium text-white hover:bg-[#d9b45a] transition"
                  >
                    DM으로 문의
                  </a>
                </div>
          ...
          <section className="px-6 py-20 bg-[#332619] border-y border-white/10">
            <div className="max-w-xl mx-auto">
              <Reveal>
                ...
                <p className="text-sm text-[#8f7e69] text-center mb-12">
              ...
              <div className="space-y-4">
                {REVIEWS.map((r, i) => (
                  <Reveal key={`${r.name}-${i}`} delay={i * 100}>
                    <figure className="rounded-2xl border border-white/10 bg-[#2b2018] p-6 relative">
                      <span
                      ...
                      <blockquote className="pt-3">
                        <p className="text-[15px] leading-[1.9] text-[#d0c3ad]">
                          {r.text}
                        </p>
                      </blockquote>
                      <figcaption className="mt-4 flex items-center gap-2 text-xs text-[#8f7e69]">
                        <span className="font-medium text-[#aa9a83]">{r.name}</span>
        ...
        {/* ───────── 예약 폼 ───────── */}
        <section id="booking" className="px-6 py-20 bg-[#332619] border-t border-white/10 scroll-mt-16">
          <div className="max-w-md mx-auto">
            ...
            <BookingForm />
            <p className="text-center text-xs text-[#8f7e69] mt-8">
              결제 후 입실 시간이 확정됩니다
            </p>
          </div>
        </section>
        ...
        {/* ───────── 멤버십 신청 ───────── */}
        <section id="membership" className="px-6 py-20 border-t border-white/10 scroll-mt-16">
          <div className="max-w-md mx-auto">
            <Reveal>
              <div className="text-center mb-10">
                <p className="text-xs tracking-[0.2em] text-[#8f7e69] uppercase mb-4">
