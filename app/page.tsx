  ...
  return (
    <main className="max-w-lg mx-auto px-4 py-12">
      ...
      <div className="mb-10 text-center">
        ...
        <h1 className="text-2xl font-bold text-[#1a1a2e] mb-2">몰입공간</h1>
        <p className="text-sm text-gray-500">방해 없이, 온전히 나만의 시간</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-8">
        ...
        >
          <div className="text-lg font-bold mb-1">1시간</div>
          <div className="text-2xl font-extrabold">3,000원</div>
        </button>
        <button
          type="button"
        ...
        >
          <div className="text-lg font-bold mb-1">2시간</div>
          <div className="text-2xl font-extrabold">5,000원</div>
        </button>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {time && (
          <div className="rounded-xl bg-indigo-50 border border-indigo-100 p-4 text-sm text-indigo-800">
            ...
            {duration}시간 &nbsp;·&nbsp;{' '}
            <strong>{PRICES[duration].toLocaleString()}원</strong>
          </div>
        )}
        ...
        <button
          ...
          className="w-full py-4 rounded-xl bg-[#1a1a2e] text-white font-bold text-base disabled:opacity-40 disabled:cursor-not-allowed hover:bg-[#2d2d4e] transition mt-2"
        >
      ...
      <p className="text-center text-xs text-gray-400 mt-6">
        결제 후 입실 시간이 확정됩니다 · <a href="/admin" className="underline">관리자</a>
      </p>
    </main>
  )
}
